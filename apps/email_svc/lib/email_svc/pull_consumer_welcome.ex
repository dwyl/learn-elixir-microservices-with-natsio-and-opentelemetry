defmodule PullConsumer.Welcome do
  ...
  @impl true
  def init([]) do
    {:ok, nil, connection_name: :gnat, stream_name: "EMAILS", consumer_name: "welcome_mailer"}
  end
  ...
  def handle_message(message, state) do
    ...
    Tracer.with_span "PullConsumer.Welcome.handle_message" do
      %Mcsv.V2.UserRequest{} =
        req =
