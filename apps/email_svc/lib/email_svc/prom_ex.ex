defmodule EmailService.PromEx do
  ...
  3. Update your `endpoint.ex` file to expose your metrics (or configure a standalone
     ...
     ```
     defmodule EmailSvcWeb.Endpoint do
  ...
  def plugins do
    [
      ...
      Plugins.Application,
      Plugins.Beam,
      {Plugins.Phoenix, router: EmailServiceWeb.Router, endpoint: EmailServiceWeb.Endpoint},
      # Plugins.Ecto,
      # Plugins.Oban,
  ...
  def dashboards do
    [
      ...
      # {:email_svc, "/grafana_dashboards/user_metrics.json"}
    ]
  end
end
