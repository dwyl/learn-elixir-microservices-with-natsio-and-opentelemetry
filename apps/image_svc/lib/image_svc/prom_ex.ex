defmodule ImageService.PromEx do
  ...
  def plugins do
    [
      ...
      Plugins.Application,
      Plugins.Beam,
      {Plugins.Phoenix, router: ImageServiceWeb.Router, endpoint: ImageServiceWeb.Endpoint},
      Plugins.Broadway,
  ...
  def dashboards do
    [
      ...
      # {:image_svc, "/grafana_dashboards/user_metrics.json"}
    ]
  end
end
