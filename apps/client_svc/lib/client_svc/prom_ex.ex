defmodule ClientService.PromEx do
  ...
  3. Update your `endpoint.ex` file to expose your metrics (or configure a standalone
     ...
     ```
     defmodule ClientSvcWeb.Endpoint do
  ...
  def dashboards do
    [
      ...
      # Custom dashboards are provisioned via /configs/grafana/dashboards/
      # and mounted to Grafana container at startup
    ]
  end
end
