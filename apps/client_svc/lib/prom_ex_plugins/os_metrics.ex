  ...
  def os_metrics(poll_rate) do
    Polling.build(
      ...
      [
        ...
        # CPU utilization
        last_value(
          [:client_svc, :prom_ex, :os_mon, :cpu, :util],
          event_name: [:prom_ex, :plugin, :os_mon],
          unit: :percent,
        ...
        # Memory metrics
        last_value(
          [:client_svc, :prom_ex, :os_mon, :memory, :total],
          event_name: [:prom_ex, :plugin, :os_mon],
          unit: :byte,
        ...
        last_value(
          [:client_svc, :prom_ex, :os_mon, :memory, :allocated],
          event_name: [:prom_ex, :plugin, :os_mon],
          unit: :byte,
        ...
        last_value(
          [:client_svc, :prom_ex, :os_mon, :system_memory, :available_memory],
          event_name: [:prom_ex, :plugin, :os_mon],
          unit: :byte,
        ...
        last_value(
          [:client_svc, :prom_ex, :os_mon, :system_memory, :free_memory],
          event_name: [:prom_ex, :plugin, :os_mon],
          unit: :byte,
